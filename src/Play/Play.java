            ...
            if (validatePosition(player, idPiece, endY, endX)) {
                ...
                if (this.isSuperPiece(idPiece)) {
                    ...
                    for (int i = minLine; i < maxLine; i++) {
                        ...
                        if (table.getHouseTable(j, i) != 0
                                && pieces.getPlayerPiece(table.getHouseTable(j, i)) != player) {
                    ...
                    if (Math.abs(lineInitial - endY) == 2 || Math.abs(collumnInitial - endX) == 2) {
                        ...
                        if (table.getHouseTable(lineMedia, collumnMedia) != 0
                                && pieces.getPlayerPiece(table.getHouseTable(lineMedia, collumnMedia)) != player) {
